...
class MemoryService:
    ...
    def save_full_profile(self, user_id: str, user_info_state: dict):
        ...
        return self.repo.upsert_user_memory(user_id, merged)
    ...
    def update_personal_info(self, user_id: str, updates: dict):
        ...
        return self.repo.upsert_user_memory(user_id, new_data)
    ...
    def reset_short_term(self, user_id: str):
        self.repo.upsert_user_memory(user_id, {"short_term_history": []})
